...
<!--==========================
  Intro Section
  ============================-->
  <section id="intro" style="background:url({{url('/frontend_design')}}/img/intro-bg.jpg) top center;">
  ...
  <main id="main">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              ...
              <div class="speaker">
                <img src="{{url('/frontend_design')}}/img/speakers/1.jpg" alt="Speaker 1" class="img-fluid">
                <div class="details">
            ...
            <div class="tab-content row justify-content-center">
              ...
              <div role="tabpanel" class="col-lg-9  tab-pane fade" id="day-2">
                ...
                <div class="row schedule-item">
                  ...
                  <div class="col-md-10">
                    <div class="speaker">
                      <img src="{{url('/frontend_design')}}/img/speakers/1.jpg" alt="Brenden Legros">
                    </div>
              ...
              <div role="tabpanel" class="col-lg-9  tab-pane fade" id="day-3">
                ...
                <div class="row schedule-item">
                  ...
                  <div class="col-md-10">
                    <div class="speaker">
                      <img src="{{url('/frontend_design')}}/img/speakers/2.jpg" alt="Hubert Hirthe">
                    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 venue-map">
            <iframe
            src="{{url('/frontend_design')}}/https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621"
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-3 col-md-4">
              <div class="venue-gallery">
                <a href="img/venue-gallery/1.jpg" class="venobox" data-gall="venue-gallery">
                  <img src="{{url('/frontend_design')}}/img/venue-gallery/1.jpg" alt="" class="img-fluid">
                </a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
              <div class="venue-gallery">
                <a href="img/venue-gallery/2.jpg" class="venobox" data-gall="venue-gallery">
                  <img src="{{url('/frontend_design')}}/img/venue-gallery/2.jpg" alt="" class="img-fluid">
                </a>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
              <div class="venue-gallery">
                <a href="img/venue-gallery/3.jpg" class="venobox" data-gall="venue-gallery">
                  <img src="{{url('/frontend_design')}}/img/venue-gallery/3.jpg" alt="" class="img-fluid">
                </a>
              </div>
            </div>
            ...
            <div class="venue-gallery">
              <a href="img/venue-gallery/4.jpg" class="venobox" data-gall="venue-gallery">
                <img src="{{url('/frontend_design')}}/img/venue-gallery/4.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="img/venue-gallery/5.jpg" class="venobox" data-gall="venue-gallery">
                <img src="{{url('/frontend_design')}}/img/venue-gallery/5.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="img/venue-gallery/6.jpg" class="venobox" data-gall="venue-gallery">
                <img src="{{url('/frontend_design')}}/img/venue-gallery/6.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="img/venue-gallery/7.jpg" class="venobox" data-gall="venue-gallery">
                <img src="{{url('/frontend_design')}}/img/venue-gallery/7.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="img/venue-gallery/8.jpg" class="venobox" data-gall="venue-gallery">
                <img src="{{url('/frontend_design')}}/img/venue-gallery/8.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="{{url('/frontend_design')}}/img/hotels/1.jpg" alt="Hotel 1" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="{{url('/frontend_design')}}/img/hotels/2.jpg" alt="Hotel 2" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="{{url('/frontend_design')}}/img/hotels/3.jpg" alt="Hotel 3" class="img-fluid">
              </div>
    ...
    <section id="gallery" class="wow fadeInUp">
      ...
      <div class="owl-carousel gallery-carousel">
        <a href="img/gallery/1.jpg" class="venobox" data-gall="gallery-carousel"><img src="{{url('/frontend_design')}}/img/gallery/1.jpg"
            alt="">
        </a>

        <a href="img/gallery/2.jpg" class="venobox" data-gall="gallery-carousel">
          <img src="{{url('/frontend_design')}}/img/gallery/2.jpg" alt="">
        </a>

        <a href="img/gallery/3.jpg" class="venobox" data-gall="gallery-carousel">
          <img src="{{url('/frontend_design')}}/img/gallery/3.jpg" alt="">
        </a>

                <a href="img/gallery/4.jpg" class="venobox" data-gall="gallery-carousel">
                  <img src="{{url('/frontend_design')}}/img/gallery/4.jpg" alt="">
                </a>
                
                <a href="img/gallery/5.jpg" class="venobox" data-gall="gallery-carousel">
                  <img src="{{url('/frontend_design')}}/img/gallery/5.jpg" alt="">
                </a>
      </div>
        ...
        <div class="row no-gutters supporters-wrap clearfix">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <div class="supporter-logo">
              <img src="{{url('/frontend_design')}}/img/supporters/1.png" class="img-fluid" alt="">
            </div>
          </div>
